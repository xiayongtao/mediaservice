...
@SpringBootTest
public class StreamControllerTest extends AbstractTransactionalJUnit4SpringContextTests {
    ...
    public void updateStream() throws Exception {
        ...
        String responseString = mvc.perform(post("/mediaservice/client")
    ...
    @Test
    public void modifyStream() throws Exception {
    }
